...
var ASM_CONSTS = {
  260264: () => { if (document.fullscreenElement) return 1; },  
 260310: () => { return Module.canvas.width; },  
 260342: () => { return parseInt(Module.canvas.style.width); },  
 260390: () => { document.exitFullscreen(); },  
 260417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260490: () => { if (document.fullscreenElement) return 1; },  
 260536: () => { return Module.canvas.width; },  
 260568: () => { return screen.width; },  
 260593: () => { document.exitFullscreen(); },  
 260620: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260753: () => { return window.innerWidth; },  
 260779: () => { return window.innerHeight; },  
 260806: () => { if (document.fullscreenElement) return 1; },  
 260852: () => { return Module.canvas.width; },  
 260884: () => { return parseInt(Module.canvas.style.width); },  
 260932: () => { if (document.fullscreenElement) return 1; },  
 260978: () => { return Module.canvas.width; },  
 261010: () => { return screen.width; },  
 261035: () => { return window.innerWidth; },  
 261061: () => { return window.innerHeight; },  
 261088: () => { if (document.fullscreenElement) return 1; },  
 261134: () => { return Module.canvas.width; },  
 261166: () => { return screen.width; },  
 261191: () => { document.exitFullscreen(); },  
 261218: () => { if (document.fullscreenElement) return 1; },  
 261264: () => { return Module.canvas.width; },  
 261296: () => { return parseInt(Module.canvas.style.width); },  
 261344: () => { document.exitFullscreen(); },  
 261371: ($0) => { Module.canvas.style.opacity = $0; },  
 261409: () => { return screen.width; },  
 261434: () => { return screen.height; },  
 261460: () => { return window.screenX; },  
 261487: () => { return window.screenY; },  
 261514: () => { return window.devicePixelRatio; },  
 261550: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261603: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 261654: () => { Module.canvas.style.cursor = 'none'; },  
 261691: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 261947: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 261998: () => { if (document.fullscreenElement) return 1; },  
 262044: () => { return window.innerWidth; },  
 262070: () => { return window.innerHeight; },  
 262097: () => { if (document.pointerLockElement) return 1; }
};
