...
var ASM_CONSTS = {
  260424: () => { if (document.fullscreenElement) return 1; },  
 260470: () => { return Module.canvas.width; },  
 260502: () => { return parseInt(Module.canvas.style.width); },  
 260550: () => { document.exitFullscreen(); },  
 260577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260650: () => { if (document.fullscreenElement) return 1; },  
 260696: () => { return Module.canvas.width; },  
 260728: () => { return screen.width; },  
 260753: () => { document.exitFullscreen(); },  
 260780: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260913: () => { return window.innerWidth; },  
 260939: () => { return window.innerHeight; },  
 260966: () => { if (document.fullscreenElement) return 1; },  
 261012: () => { return Module.canvas.width; },  
 261044: () => { return parseInt(Module.canvas.style.width); },  
 261092: () => { if (document.fullscreenElement) return 1; },  
 261138: () => { return Module.canvas.width; },  
 261170: () => { return screen.width; },  
 261195: () => { return window.innerWidth; },  
 261221: () => { return window.innerHeight; },  
 261248: () => { if (document.fullscreenElement) return 1; },  
 261294: () => { return Module.canvas.width; },  
 261326: () => { return screen.width; },  
 261351: () => { document.exitFullscreen(); },  
 261378: () => { if (document.fullscreenElement) return 1; },  
 261424: () => { return Module.canvas.width; },  
 261456: () => { return parseInt(Module.canvas.style.width); },  
 261504: () => { document.exitFullscreen(); },  
 261531: ($0) => { Module.canvas.style.opacity = $0; },  
 261569: () => { return screen.width; },  
 261594: () => { return screen.height; },  
 261620: () => { return window.screenX; },  
 261647: () => { return window.screenY; },  
 261674: () => { return window.devicePixelRatio; },  
 261710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261763: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 261814: () => { Module.canvas.style.cursor = 'none'; },  
 261851: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262107: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 262158: () => { if (document.fullscreenElement) return 1; },  
 262204: () => { return window.innerWidth; },  
 262230: () => { return window.innerHeight; },  
 262257: () => { if (document.pointerLockElement) return 1; }
};
